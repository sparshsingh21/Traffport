        ...
        body: Stack(
            children: <Widget>[
              ...
              Positioned(
                  top:_height * 0.18,
                  left: _width * 0.15,
                  child: Container(height: _height * 0.35,
                      width: _width * 0.7,
                    child: Image.network(Report.url, fit: BoxFit.cover,),
                  )),
              Positioned(
                  top:_height * 0.55,
                  left: _width * 0.02,
              ...
              Positioned(
                  ...
                  child: Container(
                      height: _height *0.09,
                      width: _width * 0.95,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.grey),child: Padding(
              ...
              Positioned(
                  top:_height * 0.72,
                  left: _width * 0.02,
                  child: Text("Date & Time:", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold))),
              Positioned(
                  top:_height * 0.78,
                  left: _width * 0.02,
                  child: Container(height: _height *0.05,
                      width: _width * 0.95,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: Colors.grey),child: Padding(
                          padding: const EdgeInsets.only(left:8.0, top: 10),child: Text(Report.dateTime, style: TextStyle(fontSize: 20,)))),),
              Positioned(
                bottom:_height * 0.04,
                left: _width * 0.27,
                child: InkWell(
